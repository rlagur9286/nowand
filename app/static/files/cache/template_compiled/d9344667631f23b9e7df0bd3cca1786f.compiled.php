...
echo $__Context->no;
				...
				<?php if($__Context->val->type=='title' && $__Context->val->idx==-1){ ?><td class="title">
					<a href="<?php echo getUrl('document_srl',$__Context->document->document_srl, 'listStyle', $__Context->listStyle, 'cpage','') ?>" rel="nofollow"><?php echo $__Context->document->getTitle() ?></a>
...
<div class="list_footer">
	...
	<div class="btnArea">
		<a href="<?php echo getUrl('act','dispBoardWrite','document_srl','') ?>" rel="nofollow" class="btn"><?php echo $__Context->lang->cmd_write ?></a>
