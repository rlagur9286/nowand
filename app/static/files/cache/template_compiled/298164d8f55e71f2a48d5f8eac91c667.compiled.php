...
<?php echo Context::addHtmlHeader('<meta name="viewport" content="width=1250">') ?>
<?php Context::loadLang('layouts/xe/lang'); ?>
...
<!--#Meta:layouts/xe/css/layout.css--><?php $__tmp=array('layouts/xe/css/layout.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:layouts/xe/css/idangerous.swiper.css--><?php $__tmp=array('layouts/xe/css/idangerous.swiper.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:layouts/xe/css/welcome.css--><?php $__tmp=array('layouts/xe/css/welcome.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:layouts/xe/css/webfont.css--><?php $__tmp=array('layouts/xe/css/webfont.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if($__Context->mid === 'xeicon'){ ?><!--#Meta:layouts/xe/css/xeicon.css--><?php $__tmp=array('layouts/xe/css/xeicon.css','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
<!--#Meta:common/xeicon/xeicon.min.css--><?php $__tmp=array('common/xeicon/xeicon.min.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if($__Context->_enable_slide){ ?><!--#Meta:layouts/xe/js/idangerous.swiper.min.js--><?php $__tmp=array('layouts/xe/js/idangerous.swiper.min.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
<!--#Meta:layouts/xe/js/layout.js--><?php $__tmp=array('layouts/xe/js/layout.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if($__Context->layout_info->use_demo ==='Y'){ ?><!--#Meta:layouts/xe/js/welcome.js--><?php $__tmp=array('layouts/xe/js/welcome.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
<!--#Meta:layouts/xe/js/jquery.parallax-scroll.min.js--><?php $__tmp=array('layouts/xe/js/jquery.parallax-scroll.min.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
					...
					<li class="hover">
						<?php if($__Context->is_logged){ ?>
							...
							<a href="<?php echo getUrl('act', 'dispMemberInfo') ?>" class="login_after">
								...
								<?php }else{ ?>
									<img src="/layouts/xe/img/ico_default.jpg" alt="<?php echo $__Context->logged_info->nick_name ?>" />
								<?php } ?>
							</a>
...
$__Context->_selected_menu = $__Context->val1;
	...
	<div class="body <?php echo $__Context->_body_class ?>">
		...
		<!-- CONTENT -->
			<?php if($__Context->layout_info->use_demo === 'Y'){ ?>
				<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('layouts/xe/demo','welcome_main.html') ?>
			<?php } ?>
		<!-- /CONTENT -->
	</div>
	<!-- END:BODY -->
	<footer class="footer" style="border-bottom-color:#CDA25A">
		<div class="f_cr_area">
			<p class="copyright">
				...
				<?php }else{ ?>
					<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('layouts/xe/demo','copyright.html') ?>
				<?php } ?>
			</p>
		</div>
	</footer>
...
<?php if($__Context->layout_info->use_login_widget != 'N'){ ?><section class="login_widget"<?php if($__Context->XE_VALIDATOR_ID != 'layouts/xedition/layout/1' || !$__Context->XE_VALIDATOR_MESSAGE){ ?> style="display:none"<?php } ?>>
	<!--#Meta:layouts/xe/css/widget.login.css--><?php $__tmp=array('layouts/xe/css/widget.login.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
