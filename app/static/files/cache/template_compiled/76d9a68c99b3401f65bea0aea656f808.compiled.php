...
늘 함께 해 왔던 추억과 시간이 내 마음에 항상 자리하고 있는 한 늘 나와 함께 할 것입니다.</p>
		...
		<li>
			<div class="fe_box now1">
				<div class="fe_top">
					<img src="/layouts/xe_funeral/img/3.jpg">
					<h2>김포 청솔수목장</h2>
				</div>
				<div class="fe_bottom">
					<p>김포시의 허가를 받아 수목장 안전성을 확보하였으며, 전문 인력이 상주 관리하는 자연친화적 수목장</p>
					<a href="http://www.chungsol.net">바로가기</a>
				</div>
			</div>
		</li>
		<li>
		...
		<li>
			<div class="fe_box now3">
				<div class="fe_top">
					<img src="/layouts/xe_funeral/img/2.jpg">
					<h2>양주 하늘안추모공원</h2>
				</div>
				<div class="fe_bottom">
					<p>천하명당 양주 불곡산 자락에 조성된 자연속 아름다운 추모공원, 양주역에서 10거리에 위치</p>
					<a href="./yangju">바로가기</a>
				</div>
			</div>
		</li>
		<li>
			<div class="fe_box now4">
				<div class="fe_top">
					<img src="/layouts/xe_funeral/img/5.jpg">
					<h2>남양주 에덴추모공원</h2>
				</div>
				<div class="fe_bottom">
					<p>서울과 가장 근접한 남양주 마석에 위치하여 수려한 자연 경관과 맑은 공기와 함께 하는 평안한 영혼의 안식처</p>
					<a href="./namyangju">바로가기</a>
				</div>
			</div>
		</li>
		</ul>
