...
<?php if($__Context->colorset == "white_texteditor" || $__Context->colorset == "black_texteditor" || $__Context->colorset == "white_text_nohtml" || $__Context->colorset == "black_text_nohtml" || $__Context->colorset == "white_text_usehtml" || $__Context->colorset == "black_text_usehtml"){ ?>
	<?php if(__DEBUG__){ ?><!--#Meta:modules/editor/skins/xpresseditor_axupload5/js/xe_textarea.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/js/xe_textarea.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
	<?php if(!__DEBUG__){ ?><!--#Meta:modules/editor/skins/xpresseditor_axupload5/js/xe_textarea.min.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/js/xe_textarea.min.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
...
<?php }else{ ?>
	...
	<?php if(__DEBUG__){ ?><!--#Meta:modules/editor/skins/xpresseditor_axupload5/js/Xpress_Editor.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/js/Xpress_Editor.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
	<?php if(__DEBUG__){ ?><!--#Meta:modules/editor/skins/xpresseditor_axupload5/js/xe_interface.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/js/xe_interface.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
	<?php if(!__DEBUG__){ ?><!--#Meta:modules/editor/skins/xpresseditor_axupload5/js/xpresseditor.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/js/xpresseditor.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
	<!-- 자동저장용 폼 -->
	...
	<div class="xpress-editor <?php echo $__Context->editor_class ?>">
		...
		<?php if($__Context->allow_fileupload){ ?><div id="fileUploader_<?php echo $__Context->editor_sequence ?>" class="fileUploader"><!--File upload zone-->
			<?php 
			 ...
			 ?>
			<?php if($__Context->tmp_files&&count($__Context->tmp_files))foreach($__Context->tmp_files as $__Context->key=>$__Context->file_info){ ?>
