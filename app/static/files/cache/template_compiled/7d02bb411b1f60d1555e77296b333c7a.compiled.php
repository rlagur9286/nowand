...
<div class="board">
	...
	<?php if($__Context->module_info->title_image || $__Context->grant->manager){ ?><div class="board_header">
		...
		<?php if($__Context->grant->manager){ ?><a class="setup" href="<?php echo getUrl('act','dispBoardAdminBoardInfo') ?>" rel="nofollow" title="<?php echo $__Context->lang->cmd_setup ?>"><?php echo $__Context->lang->cmd_setup ?></a><?php } ?>
	</div><?php } ?>
